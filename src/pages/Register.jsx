...
const Register = () => {
  ...
  // const hadleChange = (e) =>
  //   setInfo({ ...info, [e.target.id]: e.target.value }); id vermedik kullanacaksan id ver inputlara.
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="relative z-0 w-full mb-6 group">
            <input
              type="text"
              name="floating_text"
              className="peer" // peer classı input un içine label gelsin ve tıklanınca açılsın diye.
              placeholder=" "
              required
